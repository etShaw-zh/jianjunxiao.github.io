...
* **Spark Shopping** - 面向购物场景的大语言模型助手。iFLYTEK Spark Training Camp（2023.08，🥉），通用人工智能创新与应用竞赛（2023.11，🥉），中国合肥。([LINK](https://mp.weixin.qq.com/s/IGBmPkI9BBRgLGWiW0jFCQ){:target="_blank"})
...
##### **Python 包**
* **[gca_analyzer](https://gca-analyzer.readthedocs.io){:target="_blank"}** - GCA Analyzer 是一个用于分析群体对话动态的 Python 包，使用 NLP 技术和定量指标，提供对参与模式、交互动态、内容新颖性和交流密度的系统分析工具。  
...
##### **应用程序**
* **[AICodingOffier](https://xiaojianjun.cn/aicodingofficer){:target="_blank"} (AICO)** - AICO 是一个面向文本编码提效的人工智能编程助手。该应用基于 pyqt6 构建，可运行于 Windows、macOS 和 Linux。  
![AICodingOffier](/assets/img/screenshot_2.jpg){:height="50%" width="50%"}  

------
##### **网站**
* **[cMOOC Platform](https://cmooc.bnu.edu.cn){:target="_blank"}** - cMOOC Platform 是一个支持联通主义 MOOCs（cMOOCs）的在线学习平台，也是最早的社区化 cMOOC 支持平台之一，截至 2023 年 8 月已服务 16,712 名用户，并拥有较活跃的社区互动。我于 2019 年加入该项目，负责平台设计与开发推进，完成了基于 WordPress 的需求分析、功能原型和迭代开发。     
![cMOOCPlatform](/assets/img/photos/cmooc_platform.jpg){:height="50%" width="50%"} 

------
##### **Chrome 扩展**
* **[Bnu-consumption-pattern](https://github.com/etShaw-zh/bnu-consumption-pattern){:target="_blank"}** - 面向北京师范大学学生消费模式挖掘的浏览器插件。  
![Bnu-consumption-pattern](/assets/img/photos/Bnu-consuption-pattern.jpg){:height="50%" width="50%"}

------
##### **微信小程序**
* **Mini cMOOC Platform** - cMOOC 平台小程序。  
![MinicMOOCPlatform](/assets/img/photos/minicmooc.jpg){:height="50%" width="50%"}

* **智慧线学习分析系统** - 实时反馈问卷与分析系统。  
![LearningAnalysisSystem](/assets/img/photos/202001-learning-analysis-system-min.jpg){:height="50%" width="50%"}

* **RCDEALLRUN** - 一个用于打卡管理的微信小程序。  
